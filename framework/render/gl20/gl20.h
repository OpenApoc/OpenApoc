...
class GL20
{
  ...
  public:
	...
	std::function<void(GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const void *)>
	    TexImage1D;
	std::function<void(GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const void *)>
	    TexImage2D;
