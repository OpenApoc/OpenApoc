...
#define LogInfo(f, ...)                                                                            \
	OpenApoc::Log(OpenApoc::LogLevel::Info, OpenApoc::UString(LOGGER_PREFIX), f,             \
	              ##__VA_ARGS__)
#define LogWarning(f, ...)                                                                         \
	OpenApoc::Log(OpenApoc::LogLevel::Warning, OpenApoc::UString(LOGGER_PREFIX), f,          \
	              ##__VA_ARGS__)
#define LogError(f, ...)                                                                           \
	OpenApoc::Log(OpenApoc::LogLevel::Error, OpenApoc::UString(LOGGER_PREFIX), f,            \
	              ##__VA_ARGS__)
#else
...
#define LogWarning(f, ...)                                                                         \
	OpenApoc::Log(OpenApoc::LogLevel::Warning, LOGGER_PREFIX, f, __VA_ARGS__)
#define LogError(f, ...)                                                                           \
	OpenApoc::Log(OpenApoc::LogLevel::Error, LOGGER_PREFIX, f, __VA_ARGS__)
#endif
