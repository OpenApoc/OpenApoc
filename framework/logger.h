...
#define LogInfo(f, ...) OpenApoc::Log(OpenApoc::LogLevel::Info, OpenApoc::UString(__PRETTY_FUNCTION__), f, ##__VA_ARGS__)
#define LogWarning(f, ...) OpenApoc::Log(OpenApoc::LogLevel::Warning, OpenApoc::UString(__PRETTY_FUNCTION__), f, ##__VA_ARGS__)
#define LogError(f, ...) OpenApoc::Log(OpenApoc::LogLevel::Error, OpenApoc::UString(__PRETTY_FUNCTION__), f, ##__VA_ARGS__)
#else
