...
template <typename T>
Angle<T>::Angle( T Degrees )
	:curAngle(Degrees)
{
}

template <typename T>
void Angle<T>::Add( T Degrees )
{
	curAngle += Degrees;
...
template <typename T>
bool Angle<T>::ClockwiseShortestTo( const Angle<T> DestinationAngle )
{
	return ClockwiseShortestTo( DestinationAngle.ToDegrees() );
}

template <typename T>
bool Angle<T>::ClockwiseShortestTo( T DestinationAngle )
{
...
template <typename T>
void Angle<T>::RotateShortestBy( const Angle<T> DestinationAngle, T ByDegrees )
{
	return RotateShortestBy( DestinationAngle.ToDegrees(), ByDegrees );
}

template <typename T>
void Angle<T>::RotateShortestBy( T DestinationAngle, T ByDegrees )
{
...
template <typename T>
T Angle<T>::ShortestAngleTo( const Angle<T> DestinationAngle )
{
	return ShortestAngleTo( DestinationAngle.ToDegrees() );
}

template <typename T>
T Angle<T>::ShortestAngleTo( T DestinationAngle )
{
	T ang = Maths::Min(Maths::Abs(DestinationAngle - curAngle), Maths::Abs(curAngle - DestinationAngle));
	return ang;
}
