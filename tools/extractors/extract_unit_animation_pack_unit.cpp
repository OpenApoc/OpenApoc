                                                         ...
                                                         int x, int y)
{
	...
	// Standart animations
	{
		...
		p->standart_animations[ItemWieldMode::OneHanded][HandState::AtEase][MovementState::Strafing]
		                      [BodyState::Standing][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 13, {x, y}, sFrames);
		p->standart_animations[ItemWieldMode::TwoHanded][HandState::AtEase][MovementState::Strafing]
		                      [BodyState::Standing][{x, y}] =
		...
		p->standart_animations[ItemWieldMode::OneHanded][HandState::Aiming][MovementState::Strafing]
		                      [BodyState::Standing][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 78, {x, y}, true, wFrames);
		p->standart_animations[ItemWieldMode::TwoHanded][HandState::Aiming][MovementState::Strafing]
		                      [BodyState::Standing][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 82, {x, y}, true, wFrames);
		...
		p->standart_animations[ItemWieldMode::None][HandState::AtEase][MovementState::None]
			...
			getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, true, false, false, { 0,0 }, { 0,0 }, false, 0, true);
		p->standart_animations[ItemWieldMode::OneHanded][HandState::AtEase][MovementState::None]
			[BodyState::Throwing][{x, y}] =
			getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, true, false, false, { 0,0 }, { 0,0 }, false, 0, true);
		p->standart_animations[ItemWieldMode::TwoHanded][HandState::AtEase][MovementState::None]
	...
	// Body state change animations
	{
		...
		p->body_state_animations[ItemWieldMode::OneHanded][HandState::AtEase][MovementState::Normal]
		                        [BodyState::Standing][BodyState::Jumping][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 21, {x, y}, jFrames);
		p->body_state_animations[ItemWieldMode::TwoHanded][HandState::AtEase][MovementState::Normal]
		                        [BodyState::Standing][BodyState::Jumping][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 21, {x, y}, jFrames);
