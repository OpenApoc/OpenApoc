	...
	std::vector<AnimationDataUF> &dataUF, int x, int y, const InitialGameStateExtractor &e) 
{
	...
	// Standart animations
	{
		...
		p->standart_animations[{ItemWieldMode::OneHanded, HandState::AtEase,
			MovementState::None, BodyState::Downed}][{x, y}] =
			e.getAnimationEntry(dataAD, dataUA, dataUF, 27, { x, y });
		...
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase,
			MovementState::Normal, BodyState::Prone}][{x, y}] =
		...
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
			...
			e.getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, true, false,
				false, { 0, 0 }, { 0, 0 }, false, 0, true);
		p->standart_animations[{ItemWieldMode::OneHanded, HandState::AtEase,
			MovementState::None, BodyState::Throwing}][{x, y}] =
			e.getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, true, false,
				false, { 0, 0 }, { 0, 0 }, false, 0, true);
		p->standart_animations[{ItemWieldMode::TwoHanded, HandState::AtEase,
			MovementState::None, BodyState::Throwing}][{x, y}] =
	...
	// Body state change animations
	{
		...
		p->body_state_animations[{ItemWieldMode::None, HandState::AtEase,
			MovementState::None, BodyState::Prone, BodyState::Downed}]
			[{x, y}] =
		...
		p->body_state_animations[{ItemWieldMode::TwoHanded, HandState::AtEase,
			...
			e.getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, true);
		p->body_state_animations[{ItemWieldMode::None, HandState::AtEase,
			MovementState::None, BodyState::Throwing,
			BodyState::Standing}][{x, y}] =
			e.getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, false, false,
				true, { 0, 0 }, { 0, 0 }, false, 3);
		p->body_state_animations[{ItemWieldMode::OneHanded, HandState::AtEase,
			MovementState::None, BodyState::Throwing,
			BodyState::Standing}][{x, y}] =
			e.getAnimationEntry(dataAD, dataUA, dataUF, 41, { x, y }, 100, 5, false, false,
	...
	// Hand state change animation
	{
		...
		p->hand_state_animations[{ItemWieldMode::OneHanded, HandState::Aiming,
			HandState::AtEase, MovementState::None, BodyState::Prone}]
			[{x, y}] =
		...
		p->hand_state_animations[{ItemWieldMode::OneHanded, HandState::AtEase,
			HandState::Aiming, MovementState::None, BodyState::Prone}]
			[{x, y}] =
