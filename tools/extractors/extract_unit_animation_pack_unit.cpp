                                                         ...
                                                         int x, int y)
{
	...
	{
		// Downed state: 27
		p->standart_animations[ItemWieldMode::None]
		                      [HandState::AtEase][MovementState::None]
		                      [BodyState::Downed][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 27, {x, y});
		p->standart_animations[ItemWieldMode::OneHanded]
		                      [HandState::AtEase][MovementState::None]
		                      [BodyState::Downed][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 27, {x, y});
		p->standart_animations[ItemWieldMode::TwoHanded]
		                      [HandState::AtEase][MovementState::None]
		                      [BodyState::Downed][{x, y}] =
		    getAnimationEntry(dataAD, dataUA, dataUF, 27, {x, y});
		...
		p->standart_animations[ItemWieldMode::None]
		                      [HandState::AtEase][MovementState::Running]
		                      [BodyState::Standing][{x, y}] =
		...
		p->standart_animations[ItemWieldMode::OneHanded]
		                      [HandState::Aiming][MovementState::None]
		                      [BodyState::Standing][{x, y}] =
		...
		p->standart_animations[ItemWieldMode::OneHanded]
		                      [HandState::Firing][MovementState::None]
		                      [BodyState::Standing][{x, y}] =
		...
		p->standart_animations[ItemWieldMode::OneHanded]
		                      [HandState::Firing][MovementState::Normal]
		                      [BodyState::Flying][{x, y}] =
	...
	// Body state change animations
	{
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Standing][BodyState::Downed]
		                        [{x, y}] = getAnimationEntry(dataAD, dataUA, dataUF, 47, {x, y});
		p->body_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Standing][BodyState::Downed]
		                        [{x, y}] = getAnimationEntry(dataAD, dataUA, dataUF, 47, {x, y});
		p->body_state_animations[ItemWieldMode::TwoHanded]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Standing][BodyState::Downed]
		                        [{x, y}] = getAnimationEntry(dataAD, dataUA, dataUF, 47, {x, y});
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Downed][BodyState::Standing]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Kneeling][BodyState::Downed]
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Prone][BodyState::Downed]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Flying][BodyState::Downed]
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::Normal]
		                        [BodyState::Standing][BodyState::Jumping]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::Normal]
		                        [BodyState::Jumping][BodyState::Standing]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Standing][BodyState::Kneeling]
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Kneeling][BodyState::Prone]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Prone][BodyState::Kneeling]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Kneeling][BodyState::Standing]
		...
		p->body_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Standing][BodyState::Throwing]
		                        [{x, y}] =
		...
		p->body_state_animations[ItemWieldMode::None]
		                        [HandState::AtEase][MovementState::None]
		                        [BodyState::Throwing][BodyState::Standing]
		                        [{x, y}] =
	...
	// Hand state change animation
	{
		...
		p->hand_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::Aiming][HandState::AtEase]
		                        [MovementState::None][BodyState::Standing]
		                        [{x, y}] = getAnimationEntry(dataAD, dataUA, dataUF, 55, {x, y});
		p->hand_state_animations[ItemWieldMode::TwoHanded]
		                        [HandState::Aiming][HandState::AtEase]
		                        [MovementState::None][BodyState::Standing]
		...
		p->hand_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::AtEase][HandState::Aiming]
		                        [MovementState::None][BodyState::Standing]
		...
		p->hand_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::Aiming][HandState::AtEase]
		                        [MovementState::None][BodyState::Kneeling]
		...
		p->hand_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::Aiming][HandState::AtEase]
		                        [MovementState::None][BodyState::Prone]
		...
		p->hand_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::Aiming][HandState::AtEase]
		                        [MovementState::None][BodyState::Flying]
		...
		p->hand_state_animations[ItemWieldMode::OneHanded]
		                        [HandState::Aiming][HandState::AtEase]
		                        [MovementState::Normal][BodyState::Flying]
		                        [{x, y}] =
