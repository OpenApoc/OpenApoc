...
namespace OpenApoc
{
	...
	sp<BattleUnitAnimationPack::AnimationEntry>
		makeUpQAnimationEntry(int from, int count, int fromB, int countB, Vec2<int> offset)
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			for (int j = 1; j <= (noHead ? 1 : 2); j++)
			{
				...
				case 2:
					part_type =
						BattleUnitAnimationPack::AnimationEntry::Frame::UnitImagePart::Legs;
					break;
				default:
	...
	void extractAnimationPackQInternal(sp<BattleUnitAnimationPack> p)
	{
		...
		// Downed state:
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
			BodyState::Downed}][{0, 1}] =
			makeUpQAnimationEntry(0, 1, 0, 1, offset);
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
		...
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
			BodyState::Dead}][{0, 1}] =
			makeUpQAnimationEntry(49, 1, 0, 1, offset);
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
			BodyState::Dead}][{-1, 1}] =
			makeUpQAnimationEntry(49, 1, 0, 1, offset);
		p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
