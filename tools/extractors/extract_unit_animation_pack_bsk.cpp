...
// Standart animations
{
	...
	p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
		...
		getAnimationEntry(dataAD, dataUA, dataUF, 5, { x, y }, 100, 2, false, false, false, { 0,0 }, { 0,0 },false,0,true);

	// Standing state: 2's first frame
	p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::None,
		BodyState::Standing}][{x, y}] =
		getAnimationEntry(dataAD, dataUA, dataUF, 2, { x, y }, 100, 0, false, false, false, { 0,0 }, { 0,0 }, false, 0, true);
	...
	p->standart_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::Brainsucker,
		BodyState::Flying}][{x, y}] =
		getAnimationEntry(dataAD, dataUA, dataUF, 3, { x, y }, 100, 9, false, false, false, { 0,0 }, { 0,0 }, false, 0, true);
...
// Body state change animations
{
	...
	p->body_state_animations[{ItemWieldMode::None, HandState::AtEase, MovementState::Brainsucker,
		BodyState::Standing, BodyState::Flying}][{x, y}] =
		getAnimationEntry(dataAD, dataUA, dataUF, 5, { x, y });
