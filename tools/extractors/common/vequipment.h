...
struct vehicle_equipment_data_t
{
	uint8_t type;       // VEHICLE_EQUIPMENT_TYPE_*
	uint8_t data_idx;   // Index into vehicle_weapon_data_t or vehicle_engine_data_t or
	                    // vehicle_equipment_data_t
...
static_assert(sizeof(struct vehicle_equipment_data_t) == 24, "Invalid vehicle_equpment_data size");
#define VEHICLE_EQUIPMENT_DATA_OFFSET_START 1617224
#define VEHICLE_EQUIPMENT_DATA_OFFSET_END 1618398

struct vehicle_weapon_data_t
{
...
static_assert(sizeof(struct vehicle_weapon_data_t) == 34, "Invalid vehicle_weapon_data size");

#define VEHICLE_WEAPON_DATA_OFFSET_START 1618400
#define VEHICLE_WEAPON_DATA_OFFSET_END 1619248
#pragma pack(push, 1)
struct vehicle_engine_data_t
{
	uint32_t power;
	uint16_t top_speed;
};
...
static_assert(sizeof(struct vehicle_engine_data_t) == 6, "Invalid vehicle_engine_data size");

#define VEHICLE_ENGINE_DATA_OFFSET_START 1619252
#define VEHICLE_ENGINE_DATA_OFFSET_END 1619318

struct vehicle_general_equipment_data_t
{
...
static_assert(sizeof(struct vehicle_general_equipment_data_t) == 18,
