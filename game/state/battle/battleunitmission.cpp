...
namespace OpenApoc
{
    ...
    public:
        ...
        bool canEnterTile(Tile *from, Tile *to) const override
        {
            ...
            // FIXME: Handle 'large' vehicles interacting more than with just the 'owned' objects of
a
            // single tile?
            return true;
        }
            ...
            sp<TileObjectVehicle> targetTile, float distancePref) const
        {
            ...
            for (int i = 0; i < maxIterations; i++)
            {
                ...
                {
                    float currentDist = glm::abs(distancePref -
targetTile->getDistanceTo(newPosition));
