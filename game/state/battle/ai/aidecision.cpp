...
bool AIAction::inProgressInternal(BattleUnit & u)
{
	...
	{
	case AIAction::Type::AttackGrenade:
		return !u.missions.empty() && u.missions.front()->type == BattleUnitMission::Type::ThrowItem;
	case AIAction::Type::AttackWeaponTile:
		return u.isAttacking() && (u.targetingMode == BattleUnit::TargetingMode::TileCenter || u.targetingMode == BattleUnit::TargetingMode::TileGround) && u.targetTile == targetLocation;
	case AIAction::Type::AttackWeaponUnit:
		return u.isAttacking() && u.targetingMode == BattleUnit::TargetingMode::Unit && u.targetUnit == targetUnit;
	case AIAction::Type::AttackPsiMC:
	case AIAction::Type::AttackPsiStun:
	case AIAction::Type::AttackPsiPanic:
...
bool AIAction::isFinished(BattleUnit & u)
{
	return !inProgress(u) && executed;
}
...
bool AIMovement::isFinished(BattleUnit & u)
{
	return !inProgress(u) && executed;
}
