...
class VehicleTargetHelper
{
  public:
	...
	enum class Reachability
	{
		...
		BlockedByScenery,
		BlockedByBuilding // Specificaly so AI can recover vehicle at any position of the map which is not inside a building
	};
	...
	// Checks for reachability to recover AI vehicles, specificaly as seperate function since Target Tile is will always be blocked by vehicle to be rescued and mostly has no landing pad
	// Returns reachable for recovery as long as tgt tile is not part of building
