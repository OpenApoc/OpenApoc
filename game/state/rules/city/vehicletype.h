...
class VehicleType : public StateObject
{
  ...
  public:
	...
	int getMaxConstitution(IterT first, IterT last) const
	{
		return getMaxHealth(first, last) + getMaxShield(first, last);
	}
	template <class IterT>
	int getMaxHealth(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
		return this->health;
	}
	template <class IterT>
	int getMaxShield(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
		int maxShield = 0;
	...
	template <class IterT>
	int getArmor(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
		int armor = 0;
	...
	template <class IterT>
	int getAccuracy(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
		int accuracy = 0;
	...
	template <class IterT>
	int getTopSpeed(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
		return (int)getSpeed(first, last);
	}
	template <class IterT>
	int getAcceleration(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
	...
	template <class IterT>
	int getWeight(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
	...
	template <class IterT>
	int getFuel(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
	...
	template <class IterT>
	int getMaxPassengers(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
	...
	template <class IterT>
	int getMaxCargo(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
	...
	template <class IterT>
	int getMaxBio(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
	...
	template <class IterT>
	float getSpeed(IterT first, IterT last) const
	{
		static_assert(std::is_same<typename std::iterator_traits<IterT>::value_type, sp<VEquipmentType>>::value, "iterator must return sp<VehicleEquipmentType>");
