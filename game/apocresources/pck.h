...
class PCK
{
	...
	private:
		...
		void ProcessFile(std::wstring PckFilename, std::wstring TabFilename, Palette* ColourPalette, int Index);
	...
	public:
		PCK( std::wstring PckFilename, std::wstring TabFilename, Palette* ColourPalette );
		PCK( std::wstring PckFilename, std::wstring TabFilename, Palette* ColourPalette, int Index );
		~PCK();
