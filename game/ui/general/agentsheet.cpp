...
void AgentSheet::displayStats(const Agent &item, std::vector<sp<Image>> &ranks, bool turnBased)
{
	...
	statsForm->findControlTyped<Graphic>("VALUE_1")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.health, item.current_stats.health);
	...
	statsForm->findControlTyped<Graphic>("VALUE_2")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.accuracy, item.current_stats.accuracy);
	...
	statsForm->findControlTyped<Graphic>("VALUE_3")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.reactions, item.current_stats.reactions);
	...
	if (turnBased)
	{
		...
		statsForm->findControlTyped<Graphic>("VALUE_4")->ToolTipText +=
		    format(": {0}/{1}", item.modified_stats.time_units, item.current_stats.time_units);
	}
	else
	{
		...
		statsForm->findControlTyped<Graphic>("VALUE_4")->ToolTipText +=
		    format("^ {0}/{1}", item.modified_stats.getDisplaySpeedValue(),
	...
	statsForm->findControlTyped<Graphic>("VALUE_5")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.getDisplayStaminaValue(),
	...
	statsForm->findControlTyped<Graphic>("VALUE_6")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.bravery, item.current_stats.bravery);
	...
	statsForm->findControlTyped<Graphic>("VALUE_7")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.strength, item.current_stats.strength);
	...
	statsForm->findControlTyped<Graphic>("VALUE_8")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.psi_energy, item.current_stats.psi_energy);
	...
	statsForm->findControlTyped<Graphic>("VALUE_9")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.psi_attack, item.current_stats.psi_attack);
	...
	statsForm->findControlTyped<Graphic>("VALUE_10")->ToolTipText =
	    ...
	    format(": {0}/{1}", item.modified_stats.psi_defence, item.current_stats.psi_defence);
}
