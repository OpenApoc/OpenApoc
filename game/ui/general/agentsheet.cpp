...
void AgentSheet::display(sp<Agent> item, std::vector<sp<Image>> &ranks, bool turnBased)
{
	...
	form->findControlTyped<Graphic>("VALUE_1")->ToolTipText = tr("Health") + ": " +
    	...
    	if (item->current_stats.health != item->modified_stats.health)
			...
			std::to_string(item->current_stats.health);
	...
	form->findControlTyped<Graphic>("VALUE_2")->ToolTipText = tr("Accuracy") + ": " +
    	...
    	if (item->current_stats.accuracy != item->modified_stats.accuracy)
			...
			std::to_string(item->current_stats.accuracy);
	...
	form->findControlTyped<Graphic>("VALUE_3")->ToolTipText = tr("Reactions") + ": " +
    	...
    	if (item->current_stats.reactions != item->modified_stats.reactions)
			...
			std::to_string(item->current_stats.reactions);
	...
	if (turnBased)
	{
		form->findControlTyped<Graphic>("VALUE_4")->setImage(
    		...
    		form->findControlTyped<Graphic>("VALUE_4")->ToolTipText = tr("Time Units") + ": " +
								std::to_string(item->modified_stats.time_units);
        	if (item->current_stats.time_units != item->modified_stats.time_units)
            		form->findControlTyped<Graphic>("VALUE_4")->ToolTipText += "/" +
								std::to_string(item->current_stats.time_units);
	}
	else
	{
		form->findControlTyped<Graphic>("VALUE_4")->setImage(createStatsBar(
    		...
    		form->findControlTyped<Graphic>("VALUE_4")->ToolTipText = tr("Speed") + ": " +
			std::to_string(item->modified_stats.getDisplaySpeedValue());
        	if (item->current_stats.getDisplaySpeedValue() != item->modified_stats.getDisplaySpeedValue())
            		form->findControlTyped<Graphic>("VALUE_4")->ToolTipText += "/" +
				std::to_string(item->current_stats.getDisplaySpeedValue());
	}
	...
	form->findControlTyped<Graphic>("VALUE_5")->ToolTipText = tr("Stamina") + ": " +
    	...
    	if (item->current_stats.getDisplayStaminaValue() != item->modified_stats.getDisplayStaminaValue())
			...
			std::to_string(item->current_stats.getDisplayStaminaValue());
	...
	form->findControlTyped<Graphic>("VALUE_6")->ToolTipText = tr("Bravery") + ": " +
    	...
    	if (item->current_stats.bravery != item->modified_stats.bravery)
			...
			std::to_string(item->current_stats.bravery);
	...
	form->findControlTyped<Graphic>("VALUE_7")->ToolTipText = tr("Strength") + ": " +
    	...
    	if (item->current_stats.strength != item->modified_stats.strength)
			...
			std::to_string(item->current_stats.strength);
	...
	form->findControlTyped<Graphic>("VALUE_8")->ToolTipText = tr("Psi-energy") + ": " +
    	...
    	if (item->current_stats.psi_energy != item->modified_stats.psi_energy)
			...
			std::to_string(item->current_stats.psi_energy);
	...
	form->findControlTyped<Graphic>("VALUE_9")->ToolTipText = tr("Psi-attack") + ": " +
    	...
    	if (item->current_stats.psi_attack != item->modified_stats.psi_attack)
			...
			std::to_string(item->current_stats.psi_attack);
	...
	form->findControlTyped<Graphic>("VALUE_10")
	    ->setImage(createStatsBar(item->initial_stats.psi_defence, item->current_stats.psi_defence,
	                              ...
	                              {100, 4}));
	form->findControlTyped<Graphic>("VALUE_10")->ToolTipText = tr("Psi-defence") + ": " +
    	...
    	if (item->current_stats.psi_defence != item->modified_stats.psi_defence)
			...
			std::to_string(item->current_stats.psi_defence);
}
