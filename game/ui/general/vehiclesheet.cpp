...
void VehicleSheet::displayImplementation(sp<Vehicle> vehicle, sp<VehicleType> vehicleType)
{
	...
	form->findControlTyped<Label>("LABEL_1_L")->setText(tformat("Constitution"));
	form->findControlTyped<Label>("LABEL_2_L")->setText(tformat("Armor"));
	form->findControlTyped<Label>("LABEL_3_L")->setText(tformat("Accuracy"));
	form->findControlTyped<Label>("LABEL_4_L")->setText(tformat("Top Speed"));
	form->findControlTyped<Label>("LABEL_5_L")->setText(tformat("Acceleration"));
	form->findControlTyped<Label>("LABEL_6_L")->setText(tformat("Weight"));
	form->findControlTyped<Label>("LABEL_7_L")->setText(tformat("Fuel"));
	form->findControlTyped<Label>("LABEL_8_L")->setText(tformat("Passengers"));
	form->findControlTyped<Label>("LABEL_9_L")->setText(tformat("Cargo"));
...
void VehicleSheet::displayEquipImplementation(sp<VEquipment> item, sp<VEquipmentType> type)
{
	...
	form->findControlTyped<Label>("LABEL_1_L")->setText(tformat("Weight"));
...
{
	form->findControlTyped<Label>("LABEL_2_L")->setText(tformat("Top Speed"));
	form->findControlTyped<Label>("LABEL_2_R")->setText(format("%d", type->top_speed));
	form->findControlTyped<Label>("LABEL_3_L")->setText(tformat("Power"));
...
void VehicleSheet::displayGeneral(sp<VEquipment> item [[maybe_unused]], sp<VEquipmentType> type)
{
	...
	if (type->cargo_space)
	{
		form->findControlTyped<Label>(format("LABEL_%d_L", statsCount))->setText(tformat("Cargo"));
		form->findControlTyped<Label>(format("LABEL_%d_R", statsCount))
	...
	{
		form->findControlTyped<Label>(format("LABEL_%d_L", statsCount))
		    ->setText(tformat("Cloaks Craft"));
		statsCount++;
	}
	if (type->teleporting)
	{
		form->findControlTyped<Label>(format("LABEL_%d_L", statsCount))
		    ->setText(tformat("Teleports"));
		statsCount++;
	}
}
...
{
	form->findControlTyped<Label>("ITEM_NAME")->setText(tformat("Alien Artifact"));
	form->findControlTyped<Graphic>("SELECTED_IMAGE")->setImage(type->equipscreen_sprite);
	form->findControlTyped<Label>("LABEL_1_L")->setText(tformat("Weight"));
	form->findControlTyped<Label>("LABEL_1_R")->setText(format("%d", type->weight));
}
