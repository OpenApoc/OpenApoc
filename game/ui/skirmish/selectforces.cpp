    ...
    : Stage(), menuform(ui().getForm("selectforces")), skirmish(skirmish), state(*state)
{
	...
	menuform->findControlTyped<ScrollBar>("NUM_BSK_SLIDER")
	    ->addCallback(
	        ...
	        [this](Event *)
	        {
		        menuform->findControlTyped<Label>("NUM_BSK")->setText(fmt::format(
	...
	menuform->findControlTyped<ScrollBar>("NUM_EGG_SLIDER")
	    ->addCallback(
	        ...
	        [this](Event *)
	        {
		        menuform->findControlTyped<Label>("NUM_EGG")->setText(fmt::format(
	...
	menuform->findControlTyped<ScrollBar>("NUM_PSI_SLIDER")
	    ->addCallback(
	        ...
	        [this](Event *)
	        {
		        menuform->findControlTyped<Label>("NUM_PSI")->setText(fmt::format(
	    ...
	    ->addCallback(
	        ...
	        [this](Event *)
	        {
		        menuform->findControlTyped<Graphic>("SHROUD_ALIENS")
		            ->setVisible(
		                menuform->findControlTyped<CheckBox>("DEFAULT_ALIENS")->isChecked());
	        });
