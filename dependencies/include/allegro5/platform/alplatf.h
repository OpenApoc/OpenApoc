...
//#define ALLEGRO_CFG_OPENGL_S3TC_LOCKING
...
#define ALLEGRO_HAVE_TIME_H 1
#define ALLEGRO_HAVE_SYS_UTSNAME_H 1
#define ALLEGRO_HAVE_SYS_TYPES_H 1
#define ALLEGRO_HAVE_OSATOMIC_H 1
